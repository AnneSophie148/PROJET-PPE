...
# Le programme va vérifier qu'on donne bien deux arguments (fichier des liens HTML et tableau.HTML) puis crée le tableau html en imprimant dessus les lignes de codes html qui vont créer les colonnes ligne, code et url
if [ $# -ne 2 ]
then
